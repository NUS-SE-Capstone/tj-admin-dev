    ...
    <div class="left bg-wt">
      ...
      <div class="todaydata bg-wt">
          ...
          <span class="todaydataTime">
            <a href="###" @click="Refreshtime"
              ><img
                ...
                "
            /></a>
            <span> UpdateTime: {{ nowtime }}</span></span
          >
        </p>
        <div class="todaydatabody">
          <div class="todaydatacard">
            ...
            <div>
              <div class="todaydatatit">
                {{ todaydata.data.visits }}<span class="Company">k</span>
              </div>
              <div class="todaydatainfo">Today visits</div>
            </div>
          </div>
          <!-- <div class="todaydatacard">
            <img
          ...
          <div class="todaydatacard">
            ...
            <div>
              <div class="todaydatatit">
                {{ todaydata.data.stuNewNum }}<span class="Company"></span>
              </div>
              <div class="todaydatainfo">Today new students</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="boarddata bg-wt">
        <div class="boarddatahead">
          <div style="margin-top: 8px">Data Board (recent 15d)</div>
          <div class="tab">
      ...
      <!-- <div class="Todolist bg-wt">
        ...
        <div class="item-card">
          <router-link to="/order/refund">
            <div class="card">
              <div class="tit">6</div>
              <div class="info">refund</div>
            </div>
          </router-link>
          <router-link to="/marketing/index">
            <div class="card">
              <div class="tit">6</div>
              <div class="info">coupon</div>
            </div>
          </router-link>
        </div>
      </div> -->
...
const tableBar = [{ id: 1, name: 'Core' }, { id: 3, name: 'User' }]
