<template>
  <div @keydown="handleEsc">
    ...
    >
      ...
      <el-table-column label="student name" min-width="240" class-name="studentname">
      ...
      <el-table-column prop="cellPhone" label="cellphone" min-width="160" />

      <el-table-column label="gender" min-width="110" class-name="textLeft">
        <template #default="scope">
          <span>
